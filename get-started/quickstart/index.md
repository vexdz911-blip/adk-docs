...
For a detailed guide on authenticating to different models, see the [Authentication guide](https://google.github.io/adk-docs/agents/models/#google-ai-studio). This is a critical step to ensure your agent can make calls to the LLM service.
